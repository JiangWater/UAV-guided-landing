...
--tab -e 'bash -c "sleep 10; roslaunch aruco_ros single.launch; exec bash"' \
--tab -e 'bash -c "sleep 10; rosrun image_view image_view image:=/aruco_single/result; exec bash"' \
