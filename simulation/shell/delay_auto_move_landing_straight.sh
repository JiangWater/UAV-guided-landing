...
gnome-terminal --window -e 'bash -c "roslaunch simulation auto_move_landing_straight.launch; exec bash"' \
...
--tab -e 'bash -c "sleep 5; roslaunch detector simulation_detector_move_landing.launch;  exec bash"' 
